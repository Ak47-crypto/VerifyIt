      ...
      if (window.ethereum.networkVersion !== 11155111) {
        try {
          ...
          try {
            ...
            const transaction=await setProduct.productSeller(
              parseInt(QrData.sn),
              QrData.name,
              blockData.source,
            ...
            if (err.code === "INVALID_ARGUMENT")
              handleAlerts(
                `${err.code}: Please provide valid inputs`,
                "warning"
              );
    ...
    return (
      <>
        {spinner.load ? (
          ...
          <div>
            <div
              className="d-flex flex-column justify-content-center my-3 mx-3"
              style={{ minHeight: "calc(100vh - 152px)", opacity: ".9" }}
            >
              <div className="row">
