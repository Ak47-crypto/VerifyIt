...
function Login() {
  ...
  const [fadeIN4, setFadeIn4] = useState();
      ...
      <div className="container my-3" style={styles.divHeight}>
        <div className="row ">
          <div className="col-md-8 col-lg-7 col-xl-6 my-3">
            <div
              ref={ref}
              className={` card ${fadeIN1 ? "fadein" : "fadeout"} `}
              onMouseOver={() => setFadeIn1(true)}
              onMouseLeave={() => setFadeIn1(false)}
              style={styles.box}
            >
          ...
          <div className="col-md-8 col-lg-7 col-xl-6 my-3">
            <div
              ref={ref}
              className={`  card ${fadeIN2 ? "fadein" : "fadeout"} `}
              onMouseOver={() => setFadeIn2(true)}
              onMouseLeave={() => setFadeIn2(false)}
              style={styles.box}
            >
              <div className="card-body">
          ...
          <div className="col-md-8 col-lg-7 col-xl-6 my-3">
            <div
              ref={ref}
              className={`  card ${fadeIN3 ? "fadein" : "fadeout"} `}
              onMouseOver={() => setFadeIn3(true)}
              onMouseLeave={() => setFadeIn3(false)}
              style={styles.box}
            >
              <div className="card-body">
                <h5 className="card-title">Consumer Login</h5>
                <p className="card-text">Verify your product</p>
                <Link to={"/login/consumerLogin"} className="btn btn-primary">
                  Verify Product
                </Link>
              </div>
            </div>
          ...
          <div className="col-md-8 col-lg-7 col-xl-6 my-3">
            <div
              ref={ref}
              className={` card ${fadeIN4 ? "fadein" : "fadeout"} `}
              onMouseOver={() => setFadeIn4(true)}
              onMouseLeave={() => setFadeIn4(false)}
              style={styles.box}
            >
              <div className="card-body">
                <h5 className="card-title">Admin Login</h5>
                <p className="card-text">Administration Setting</p>
                <Link
                  to={"/login/adminLogin"}
                  className="btn btn-primary"
                >
